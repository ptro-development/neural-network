...
do
    ...
    added_layer_test '[{"command":"modify_layers","position":4,"layers_neurons":[7, 4],"conditional":true,"condition_epoch>":EPOCH},{"command":"set_layers_locks","locks":[true,true,true,true,[true,true,true,true,false,false,false],false],"conditional":true,"condition_epoch>":EPOCH},{"command":"train_from_snapshot","position":3,"conditional":true,"condition_epoch>":EPOCH}]' "${TEST_CASE}" "${LAYERS}" "${EPOCH_LAYERS_ADDED}"
    ...
    LOG_NAME=`echo ${TEST_CASE} | sed "s/ /_/g"`
    LOG="/tmp/results_${LOG_NAME}.txt"
    added_layer_test '[{"command":"modify_layers","position":4,"layers_neurons":[7, 4],"conditional":true,"condition_epoch>":EPOCH},{"command":"set_layers_locks","locks":[true,true,true,true,false,false],"conditional":true,"condition_epoch>":EPOCH},{"command":"train_from_snapshot","position":3,"conditional":true,"condition_epoch>":EPOCH}]' "${TEST_CASE}" "${LAYERS}" "${EPOCH_LAYERS_ADDED}"
...
#    LOG_NAME=`echo ${TEST_CASE} | sed "s/ /_/g"`
#    LOG="/tmp/results_${LOG_NAME}.txt"
#    added_layer_test '[{"command":"modify_layers","position":4,"layers_neurons":[7, 4],"conditional":true,"condition_epoch>":EPOCH},{"command":"set_layers_locks","locks":[false,false,false,false,false,false],"conditional":true,"condition_epoch>":EPOCH}]' "${TEST_CASE}" "${LAYERS}" "${EPOCH_LAYERS_ADDED}"
#
#    clean_command_file
#    INITIAL_NETWORK="${8}"
#    LAYERS="4,6,7,7,4"
...
#    LOG_NAME=`echo ${TEST_CASE} | sed "s/ /_/g"`
#    LOG="/tmp/results_${LOG_NAME}.txt"
#    added_layer_test '[{"command":"modify_layers","position":2,"layers_neurons":[13, 4],"conditional":true,"condition_epoch>":EPOCH},{"command":"set_layers_locks","locks":[false,false,false,false],"conditional":true,"condition_epoch>":EPOCH}]' "${TEST_CASE}" "${LAYERS}" "${EPOCH_LAYERS_ADDED}"
#
#    clean_command_file
#    INITIAL_NETWORK="${10}"
#    LAYERS="4,14,6,4"
